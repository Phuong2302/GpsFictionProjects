...
/**
 * Formatting of MyGeoPoint.
 */
public class MyGeoPointFormatter {
     ...
     * @see format()
     */
    public MyGeoPointFormatter(final String format) {
        enumFormat = null;
        this.format = format;
    }
     ...
     * @see MyGeoPointFormatter.Format
     */
    public MyGeoPointFormatter(final Format format) {
        enumFormat = format;
        this.format = format.toString();
    }

    /**
     * Formats a MyGeoPoint.
     * <p/>
     * Syntax:
     * %[dir][precision][value]
     * <p/>
     ...
     *
     * @param gp     the MyGeoPoint to format
     * @param format the format-string with syntax from above
     * @return the formatted coordinates
     */
    public static String format(final String format, final MyGeoPoint gp) {
     ...
     */
    public static String format(final Format format, final MyGeoPoint gp) {
    ...
    /**
     * Formats a MyGeoPoint with the format of this instance.
     *
     * @param gp the MyGeoPoint to format
     * @return the formatted coordinates of the MyGeoPoint
     */
    public String format(final MyGeoPoint gp) {
        if (null == enumFormat) {
