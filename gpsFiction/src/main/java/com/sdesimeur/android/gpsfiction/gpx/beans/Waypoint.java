...
package com.sdesimeur.android.gpsfiction.gpx.beans;

import com.sdesimeur.android.gpsfiction.gpx.types.FixType;
...
public class Waypoint extends Extension {
     ...
     * &lt;magvar&gt; tag value.
     *
     * @param magneticDeclination A String representing the magnetic declination of this
     *                            waypoint.
     */
    ...
    public String toString() {
        ...
        sb.append("lat:" + this.getLatitude() + " ");
        sb.append("lon:" + this.getLongitude() + " ");
